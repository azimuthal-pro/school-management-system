...
--
-- Host: localhost
-- Generation Time: Jun 08, 2026 at 10:02 PM
...
(1, 'Test User', 'test@example.com', '$2y$10$QUBptZIr.WO2q1SBIcesBe4i4fQYYONGY04NzHd.lALj.UZDjXUtm', 'admin', '2026-06-02 20:48:28', '2026-06-08 20:40:07'),
(2, 'emma', 'emmanuelquarshie171@gmail.com', '$2y$10$HkHxsLnXvfPdPwd0PAA6WOohE8QTBK0kMXVC5mDEyYEuRXKoT6hCi', 'student', '2026-06-02 21:00:04', '2026-06-02 21:00:04');
...
ALTER TABLE `attendance`
  ...
  ADD CONSTRAINT `attendance_ibfk_3` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `grades`
  ...
  ADD CONSTRAINT `grades_ibfk_4` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`) ON DELETE SET NULL;
